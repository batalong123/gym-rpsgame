...
class RPSTournment():
	...
	def info_game(self, winner, episode):
		self.winner = winner
		self.ngames = episode
	...
	def play_game(self, player, bot, turn):
	...
	def __draw_tools(self):
		...
		#text player
		Player = self.font.render('Player 1', True, (255, 255, 255))
		Bot = self.font.render('Player 2', True, (255, 255, 255))
		versus  = self.font.render('VS', True, (255, 0, 0))
		text_position1 = [245, 355]
		text_position2 = [495, 355]
		...
		self.display_message(f'Game | {self.ngames}', 425)
		self.display_message(f"Score | PL1 {self.winner[0]} : {self.winner[1]} PL2", 450)
		self.display_message(f"Turns |  {self.count}", 475)
		#self.display_message(f"Player 2 hand gesture: {self.bot_choice}", 500)
